...
<div class="validation-form" style="margin-top: 0;">
	<h2 style="text-transform: capitalize; margin: 0px; background-color:transparent;"><?php if($row) { echo $row['FirstName']."&nbsp;".$row['MiddleName']."&nbsp".$row['LastName'];} else { echo "Null"; } ?> -&nbsp;&nbsp;<font color="black"><?php if($row>0) { echo "Employee ID ::&nbsp;".$row['EmployeeId']; } else { echo "<b>Employee ID</b> ::&nbsp; Null"; }?></font></h2>
	<div class="row">
		<div class="col-md-5">
			<table>
				<tbody>
